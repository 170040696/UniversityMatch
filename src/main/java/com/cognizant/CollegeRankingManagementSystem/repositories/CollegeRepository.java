...
public interface CollegeRepository extends JpaRepository<College, Integer> {
	 ...
	 Optional<College> findBySupportEmail(String email);
	 
//	 boolean findBySupportEmail1(String email);
	 
	 College findByAdmissionEmail(String email);
	 
	 boolean existsBySupportEmail(String email);  // Correct naming convention
	 
	 @Transactional
	 void deleteBySupportEmail(String email);
