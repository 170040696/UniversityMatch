...
<%@ page import="com.cognizant.CollegeRankingManagementSystem.repositories.CollegeRepository" %>
	...
	%>
		...
		<form class="content">
			...
			<div class="vertical-menu">
			     ...
			     <a href="collegeView" name="updateCollege" id="updateCollege">Update College</a> 
			      <a href="deleteCollegeView" name="deleteCollege" id="deleteCollege">Delete College</a> 
				<!-- <a href="updateCollege?email=medrukortu@gufum.com" name="updateCollege" id="updateCollege">Update College</a> -->
				
				<!-- <a href="#" onclick="updatecollege()">Update college</a> -->
			    
				<!-- <a href="#" onclick="Deletecollege()">Delete college</a> -->
				
					<!-- <a href="addCollege" name="addCollege" id="addCollege">Add College</a> -->
		...
		<script>
			...
			function updatecollege(){
				...
				window.location.href="updateCollege?email=" + encodeURIComponent(email);
			}
			function Deletecollege(){
				var email=document.getElementById("email").innerText.trim();
				window.location.href="deleteCollege?email=" + encodeURIComponent(email);
			}
		</script>
...
/* Rest of your existing CSS remains the same */
    ...
    /* Form Styles */
    .content {
        background:linear-gradient(241deg, #42474b 0%, #000000 80%);
        color: #fff;
        border-radius: 12px;
        padding: 25px;
        width: 450px;
    ...
    .footercontent .social a span:hover {
        background: #ff952b;
    ...
    .place span, .phone span, .email span {
        margin-left: 15px;
        color: #bdc3c7;
        line-height: 1.6;
    }
...
<body>
    <div class="container-fluid p-0">
       <nav class="navbar navbar-expand-lg my-navbar">
    <a class="navbar-brand" href="/adminFrontPage">College Ranking Management System</a>
    ...
    <div class="menu">
        ...
        <center>
            ...
            <form class="content">
                <h2>Admin Actions</h2>
                <div class="vertical-menu">
                    <a href="/collegeView" name="updateCollege" id="updateCollege">
                        <i class="fas fa-edit"></i> Update College
                    </a> 
                    <a href="/deleteCollegeView" name="deleteCollege" id="deleteCollege">
                ...
                <div class="c box">
                    ...
                    <div class="footercontent">
                        <div class="place">
                            ...
                            <span class="text">No 5/535, Old Mahabalipuram Road, Okkiam -Thoraipakkam, Chennai 600096, Tamil Nadu, India.</span>
                        </div>
                    </div>
                </div>
                <div class="r box">
                    ...
                    <div class="footercontent">
                        <div class="phone">
                            ...
                            <span class="text">+91-7547808959</span>
                        </div>
                        <div class="email">
                            <span class="fas fa-envelope"></span> 
                            <span class="text">college.ranking@gmail.com</span>
                        </div>
                    </div>
                </div>
            </div>
