...
<body>
	...
	<center>
		<br>
		<p style="color: black; font-size: 20px;">Thank you for
			Registering with us!</p>
		<p
			style="border: 1px solid white; background-color: red; width: 1100px; border-radius: 20px; color: white; font-size: 20px;">A
			verification email is sent to your email address, Please fill your
			details in the below form and verify your email address</p>
