...
<!-- <script>
    firebase.auth().onAuthStateChanged(function(user) {
        if (user) {
            // User is still logged in, so force logout
            firebase.auth().signOut().then(() => {
                console.log("Auto signed out after form submission");
	...
	<form:form action="/addCollege" method="post" modelAttribute="college"
		...
		<div class="column">
			<table>
				...
				<tr>
					<td><form:label path="collegeName">College Name: </form:label>
					</td>
					<td><form:input path="collegeName"></form:input></td>
				</tr>
				<tr>
					<td><form:label path="supportEmail">Support Email: </form:label>
					</td>
					<td><form:input path="supportEmail"></form:input></td>
				</tr>
				<tr>
					<td><form:label path="admissionEmail">Registered Email: </form:label>
					</td>
					<td><form:input path="admissionEmail"></form:input></td>
				</tr>
				<tr>
					<td><form:label path="collegeWebsite">College Website: </form:label>
					</td>
					<td><form:input path="collegeWebsite"></form:input></td>
				</tr>
				<tr>
					<td><form:label path="noOfProfessors">No Of Professors: </form:label>
					</td>
				...
				<tr>
					<td><form:label path="minimumRank">Minimum Rank: </form:label>
					</td>
					<td><form:input path="minimumRank"></form:input></td>
				</tr>
				<tr>
					<td><form:label path="averagePackage">Average Package: (LPA)</form:label>
					</td>
					<td><form:input path="averagePackage"></form:input></td>
				</tr>
				<tr>
					<td><form:label path="topPackage">Top Package: (LPA)</form:label>
					</td>
					<td><form:input path="topPackage"></form:input></td>
				</tr>
				<tr>
					<td><form:label path="noOfPartnerCompanies">No. Of Partner Companies: </form:label>
					</td>
		...
		<div class="column">
			<table>
				<tr>
					<td><form:label path="scholarships">Scholarships: (CSV)</form:label>
					</td>
					<td><form:input path="scholarships"></form:input></td>
				</tr>
				<tr>
					<td><form:label path="noOfScholarships">No. Of Scholarships: </form:label>
					</td>
					<td><form:input path="noOfScholarships"></form:input></td>
				</tr>
				<tr>
					<td><form:label path="numberOfStudentsPerFaculty">Number of Students per Faculty:
								</form:label></td>
					<td><form:input path="numberOfStudentsPerFaculty"></form:input>
					</td>
				</tr>
				<tr>
					<td><form:label path="placementPercentage">Placement Percentage: </form:label>
					</td>
					<td><form:input path="placementPercentage"></form:input></td>
				</tr>
				<tr>
					<td><form:label path="researchPublished">Research Papers Published: </form:label>
					</td>
				...
				<tr>
					<td><form:label path="minimumMarks">Minimum Marks: </form:label>
					</td>
				...
				<tr>
					<td><form:label path="passPercentage">Pass Percentage: </form:label>
					</td>
