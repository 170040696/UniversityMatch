...
class FirebaseTests {
	...
	// The below are College Authentication class tests with old firebase project deatils:
...
//	}
	...
	public void testCollegeAuthentication()
	{
		CollegeAuthentication newCollegeAuthentication = new CollegeAuthentication("AIzaSyBHMu4Y_Vqy1mK-ihobNg7kowhF2HG7d94", "collegerankingsystem-college.firebaseapp.com", "collegerankingsystem-college", "collegerankingsystem-college.firebasestorage.app", "281566524027", "1:281566524027:web:6a5a46cbd22677dc6ee8de");
		assertEquals(collegeAuthentication.toString(), newCollegeAuthentication.toString());
	}
	
	
	//with old firebase project details
	/*
	 * @Test public void testCollegeAuthenticationSetters() { CollegeAuthentication
	 * newCollegeAuthentication = new CollegeAuthentication();
	 ...
	 * ); newCollegeAuthentication.setAuthDomain(
	 * "college-ranking-system.firebaseapp.com");
	 * newCollegeAuthentication.setMessagingSenderId("494464462526");
	 * newCollegeAuthentication.setProjectId("college-ranking-system");
	 * newCollegeAuthentication.setStorageBucket(
	 * "college-ranking-system.appspot.com");
	 * assertEquals(collegeAuthentication.toString(),
	 * newCollegeAuthentication.toString()); }
	 */	
	...
	public void testCollegeAuthenticationSetters()
	{
		...
		newCollegeAuthentication.setApiKey("AIzaSyBHMu4Y_Vqy1mK-ihobNg7kowhF2HG7d94");
		newCollegeAuthentication.setAppId("1:281566524027:web:6a5a46cbd22677dc6ee8de");
		newCollegeAuthentication.setAuthDomain("collegerankingsystem-college.firebaseapp.com");
		newCollegeAuthentication.setMessagingSenderId("281566524027");
		newCollegeAuthentication.setProjectId("collegerankingsystem-college");
		newCollegeAuthentication.setStorageBucket("collegerankingsystem-college.firebasestorage.app");
		assertEquals(collegeAuthentication.toString(), newCollegeAuthentication.toString());
	}
